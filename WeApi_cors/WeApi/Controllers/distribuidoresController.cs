...
namespace WeApi.Controllers
{
    public class distribuidoresController : ApiController
    {
        ...
        public IHttpActionResult Get()
        {
            ...
            string query = "SELECT id, nombre from cf_distribuidores where estado=1 order by nombre;";
        ...
        public IHttpActionResult Get(int id)
        {
            ...
            string query = string.Format("SELECT * from cf_distribuidores where id='{0}'", id);
            DataTable tabla = Database.runSelectQuery(query);
            return Json(utilidades.convertDataTableToJson(tabla));
        }
